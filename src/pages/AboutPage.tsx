...
const stats = [
    ...
    { value: '1500+', label: 'Influencers Colabs' },
...
//   { value: '50+',  label: 'Clients Served'      },
//   { value: '5+',   label: 'Years of Experience'  },
//   { value: '2500+',label: 'Influencer Collabs'   },
//   { value: '98%',  label: 'Client Satisfaction'  },
// ];
...
//                 className="border-t border-[#D91E36]/20 pt-8 pr-8 pb-8"
//               >
//                 <span className="text-[#D91E36]/40 text-sm font-light block mb-4">
...
//               viewport={{ once: true }}
//             >
//               <p className="text-[#D91E36] text-xs font-bold tracking-[0.28em] uppercase mb-3">The People</p>
...
//               viewport={{ once: true }}
//               className="hidden md:block text-white/35 text-sm leading-relaxed max-w-xs text-right"
//             >
//               A tight-knit crew of strategists, creatives, and storytellers dedicated to building brands that scale.
//             </motion.p>
//           </div>

//           {/* ── 5-column grid ──
//                grid-cols-2 on mobile (2 per row)
//                sm:grid-cols-3 on small tablet (3 per row)
//                lg:grid-cols-5 on desktop (5 per row — one card per team member)
//           ── */}
...
//               >
//                 {/* Photo */}
//                 <div className="relative aspect-[3/4] overflow-hidden rounded-xl mb-4 bg-white/5">
//                   {/* Hover tint */}
//                   <div className="absolute inset-0 bg-[#D91E36]/0 group-hover:bg-[#D91E36]/12 transition-colors duration-400 z-10 rounded-xl" />
//                   <img
//                     src={member.image}
//                     alt={member.name}
//                     className="w-full h-full object-cover object-top group-hover:scale-105 transition-transform duration-500"
//                   />
//                   {/* Bottom gradient for name contrast */}
//                   <div className="absolute bottom-0 left-0 right-0 h-1/3 bg-gradient-to-t from-black/40 to-transparent rounded-b-xl z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
//                 </div>

//                 {/* Info */}
//                 <div>
//                   {/* Index marker */}
//                   <span className="text-[#D91E36]/30 text-[10px] font-bold tracking-[0.2em] uppercase">
//                     {String(i + 1).padStart(2, '0')}
//                   </span>
//                   <h4 className="text-white font-semibold text-sm mt-0.5 leading-snug group-hover:text-[#D91E36] transition-colors duration-200">
//                     {member.name}
//                   </h4>
//                   <p className="text-white/40 text-[11px] mt-1 leading-snug">{member.role}</p>
//                 </div>

//                 {/* Bottom accent line — expands on hover */}
//                 <div className="mt-3 h-px bg-white/8 overflow-hidden">
//                   <div className="h-full w-0 group-hover:w-full bg-[#D91E36]/50 transition-all duration-500" />
//                 </div>
//               </motion.div>
//             ))}
//           </div>
